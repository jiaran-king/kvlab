...
def make_config(base, run):
    return ReplayBenchConfig.model_validate({
     ...
     'replay':{'trace_path':str(base/'stage-v4/selected-trace.jsonl'),'sample_seed':0,'interval_mode':'trace','trace_same_agent_gap_scale':0.1,'trace_same_agent_gap_offset_seconds':0,'max_input_tokens':None,'max_output_tokens':None,'context_adjustment_mode':'adaptive','request_timeout_seconds':900}})
