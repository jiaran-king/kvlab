...
root,run=map(Path,sys.argv[1:3]);base=root/'evidence/pd-capacity-20260919/stage-v5';runtime=root/'runtime/lib/python3.12/site-packages/vllm'
files={}
...
for p in list(base.glob('*.py'))+list((base/'hook').glob('*.py')):
